...
func NewUpgradedaadhaarxmlGenerateOtp400Response() *UpgradedaadhaarxmlGenerateOtp400Response {
	this := UpgradedaadhaarxmlGenerateOtp400Response{}
	return &this
}
...
func (o UpgradedaadhaarxmlGenerateOtp400Response) MarshalJSON() ([]byte, error) {
...
type NullableUpgradedaadhaarxmlGenerateOtp400Response struct {
	value *UpgradedaadhaarxmlGenerateOtp400Response
	isSet bool
}

func (v NullableUpgradedaadhaarxmlGenerateOtp400Response) Get() *UpgradedaadhaarxmlGenerateOtp400Response {
	return v.value
}

func (v *NullableUpgradedaadhaarxmlGenerateOtp400Response) Set(val *UpgradedaadhaarxmlGenerateOtp400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradedaadhaarxmlGenerateOtp400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradedaadhaarxmlGenerateOtp400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradedaadhaarxmlGenerateOtp400Response(val *UpgradedaadhaarxmlGenerateOtp400Response) *NullableUpgradedaadhaarxmlGenerateOtp400Response {
	return &NullableUpgradedaadhaarxmlGenerateOtp400Response{value: val, isSet: true}
}

func (v NullableUpgradedaadhaarxmlGenerateOtp400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradedaadhaarxmlGenerateOtp400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
