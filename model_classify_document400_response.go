...
func NewClassifyDocument400Response() *ClassifyDocument400Response {
	this := ClassifyDocument400Response{}
	return &this
}
...
type NullableClassifyDocument400Response struct {
	value *ClassifyDocument400Response
	isSet bool
}

func (v NullableClassifyDocument400Response) Get() *ClassifyDocument400Response {
	return v.value
}

func (v *NullableClassifyDocument400Response) Set(val *ClassifyDocument400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableClassifyDocument400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableClassifyDocument400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassifyDocument400Response(val *ClassifyDocument400Response) *NullableClassifyDocument400Response {
	return &NullableClassifyDocument400Response{value: val, isSet: true}
}
