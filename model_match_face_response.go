...
type NullableMatchFaceResponse struct {
	value *MatchFaceResponse
	isSet bool
}

func (v NullableMatchFaceResponse) Get() *MatchFaceResponse {
	return v.value
}

func (v *NullableMatchFaceResponse) Set(val *MatchFaceResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMatchFaceResponse(val *MatchFaceResponse) *NullableMatchFaceResponse {
	return &NullableMatchFaceResponse{value: val, isSet: true}
}
