...
func NewCheckImageQuality400Response() *CheckImageQuality400Response {
	this := CheckImageQuality400Response{}
	return &this
}
...
type NullableCheckImageQuality400Response struct {
	value *CheckImageQuality400Response
	isSet bool
}

func (v NullableCheckImageQuality400Response) Get() *CheckImageQuality400Response {
	return v.value
}

func (v *NullableCheckImageQuality400Response) Set(val *CheckImageQuality400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckImageQuality400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckImageQuality400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckImageQuality400Response(val *CheckImageQuality400Response) *NullableCheckImageQuality400Response {
	return &NullableCheckImageQuality400Response{value: val, isSet: true}
}
