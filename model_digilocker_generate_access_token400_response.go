...
func NewDigilockerGenerateAccessToken400Response() *DigilockerGenerateAccessToken400Response {
	this := DigilockerGenerateAccessToken400Response{}
	return &this
}
...
func (o DigilockerGenerateAccessToken400Response) MarshalJSON() ([]byte, error) {
...
type NullableDigilockerGenerateAccessToken400Response struct {
	value *DigilockerGenerateAccessToken400Response
	isSet bool
}

func (v NullableDigilockerGenerateAccessToken400Response) Get() *DigilockerGenerateAccessToken400Response {
	return v.value
}

func (v *NullableDigilockerGenerateAccessToken400Response) Set(val *DigilockerGenerateAccessToken400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDigilockerGenerateAccessToken400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDigilockerGenerateAccessToken400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDigilockerGenerateAccessToken400Response(val *DigilockerGenerateAccessToken400Response) *NullableDigilockerGenerateAccessToken400Response {
	return &NullableDigilockerGenerateAccessToken400Response{value: val, isSet: true}
}

func (v NullableDigilockerGenerateAccessToken400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDigilockerGenerateAccessToken400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
