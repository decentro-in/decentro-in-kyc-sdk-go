...
func NewDigilockerInitiateSession400Response() *DigilockerInitiateSession400Response {
	this := DigilockerInitiateSession400Response{}
	return &this
}
...
type NullableDigilockerInitiateSession400Response struct {
	value *DigilockerInitiateSession400Response
	isSet bool
}

func (v NullableDigilockerInitiateSession400Response) Get() *DigilockerInitiateSession400Response {
	return v.value
}

func (v *NullableDigilockerInitiateSession400Response) Set(val *DigilockerInitiateSession400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDigilockerInitiateSession400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDigilockerInitiateSession400Response) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableDigilockerInitiateSession400Response(val *DigilockerInitiateSession400Response) *NullableDigilockerInitiateSession400Response {
	return &NullableDigilockerInitiateSession400Response{value: val, isSet: true}
}

func (v NullableDigilockerInitiateSession400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDigilockerInitiateSession400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
